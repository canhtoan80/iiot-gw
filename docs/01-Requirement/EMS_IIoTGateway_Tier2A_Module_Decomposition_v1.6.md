...
*Phiên bản 1.6 — Bổ sung chiến lược Mosquitto Bridge → EMQX OT đầy đủ: 5 vấn đề kỹ thuật thực tế (cleansession/local_cleansession, retain Sparkplug B, duplicate deduplication, queue sizing, Config/DCMD chiều ngược); cấu hình production-grade mosquitto.conf; ACL file; kịch bản EMQX OT down step-by-step; verification checklist; sơ đồ kiến trúc cập nhật; systemd dependency.*  
